 ...
 *	@author Robin Grass <http://uiux.se/>
 */
class InlineQuote extends \Nimbl\Renderers\Markdown\Tokenizer\Token {
	 ...
	 */
	protected $decoration = "<q>%s</q>";

	/**
	 *	callback
	 *
	 *	Returns decorated inline quote token.
	 *
